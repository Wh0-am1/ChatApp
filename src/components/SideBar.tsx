...
function SideBar({ setDark, setShowBar, ShowBar }: PROPTYPE) {
    function HandleTheme() {
        setDark((prev: boolean): boolean => {
    ...
    return (
        <div>
            ...
            <div
                className={`${ShowBar ? "w-16" : "w-0 max-lg:overflow-hidden"} max-lg:absolute max-lg:z-40 lg:w-16 `}
            >
                <div className="flex flex-col bg-secondary-light dark:bg-secondary-dark h-screen dark:text-gray-300 text-lightText justify-between items-center border-r border-gray-300 dark:border-r-gray-600">
                    ...
                    <div className="pb-3">
                        <ul className="icons flex flex-col gap-3">
                            <li className="group" onClick={HandleTheme}>
